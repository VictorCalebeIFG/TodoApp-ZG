...
public class Main {
    public static void main(String[] args) {
        ...
        Task myTask4 = new Task("Criar um programa todolist", "O pessoal do aceleraZG pediu um app em java :O", LocalDateTime.now(), "done",4,"estudos");
        
        MyCanvas.adicionarTask(myTask1);
        MyCanvas.adicionarTask(myTask2);
        MyCanvas.adicionarTask(myTask3);
        MyCanvas.adicionarTask(myTask4);
